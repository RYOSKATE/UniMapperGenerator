...
public class LabeledAltImpl extends MinimalEObjectImpl.Container implements LabeledAlt
{
  ...
  {
    return UniMapperGeneratorPackage.Literals.LABELED_ALT;
  }
  ...
  public NotificationChain basicSetBody(Alternative newBody, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, UniMapperGeneratorPackage.LABELED_ALT__BODY, oldBody, newBody);
  ...
  public void setBody(Alternative newBody)
  {
    if (newBody != body)
    {
      ...
      if (body != null)
        msgs = ((InternalEObject)body).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - UniMapperGeneratorPackage.LABELED_ALT__BODY, null, msgs);
      if (newBody != null)
        msgs = ((InternalEObject)newBody).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - UniMapperGeneratorPackage.LABELED_ALT__BODY, null, msgs);
      msgs = basicSetBody(newBody, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UniMapperGeneratorPackage.LABELED_ALT__BODY, newBody, newBody));
  }
  ...
  public void setLabel(String newLabel)
  {
    ...
    label = newLabel;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UniMapperGeneratorPackage.LABELED_ALT__LABEL, oldLabel, label));
  }
