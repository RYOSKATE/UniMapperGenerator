...
entryRuleId_ returns [String current=null]:
	{ newCompositeNode(grammarAccess.getId_Rule()); }
	iv_ruleId_=ruleId_
	{ $current=$iv_ruleId_.current.getText(); }
	EOF;

// Rule Id_
ruleId_ returns [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()]
@init {
	enterRule();
}
@after {
