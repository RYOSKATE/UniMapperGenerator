...
public class UniMapperGeneratorGenerator extends AbstractGenerator {
  ...
  public CharSequence generateMapper(final Grammar g) {
    ...
    _builder.newLine();
    _builder.append("\t    ");
    _builder.append("return this.parseCore(chars);");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("}");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("\t");
    _builder.append("public visit(node:ParseTree) {");
    _builder.newLine();
    _builder.append("\t    ");
    ...
    _builder.newLine();
    _builder.append("\t    ");
    _builder.append("const ruleName = this.getRuleName(node);");
    _builder.newLine();
    _builder.append("\t    ");
    _builder.append("console.log(\'*** visit Rule : \' + ruleName + \' ***\');");
    _builder.newLine();
    _builder.append("\t    ");
    _builder.append("const ret = node.accept(this);");
    _builder.newLine();
    _builder.append("\t    ");
    _builder.append("console.log(\'returned: \' + ret);");
    _builder.newLine();
    _builder.append("\t    ");
